<template>
	<div class="coupon">
		<div class="mask" v-if="showCouponToUseDialog">
      <div class="newuser-2" ref="couponBox">
        <div class="newuser-2-title"></div>
        <div class="newuser-2-text" @click="goToCoupon">可在“我的-我的优惠券”查看>></div>
        <ul class="coupon-list-2">
          <li class="coupon-li">
          ...
          <li class="coupon-li">
            ...
            <div class="coupon-right">
              <p class="money">
				...
				<div class="newuser-2-close" @click="couponClose2"></div>
        <div class="couponClose" @click="couponClose2"></div>
			</div>
		</div>
	</div>
</template>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations(['setLoginStatus', 'setshowCouponToUseDialog'])
  },
  watch: {
    showCouponToUseDialog (newValue) {
      if (newValue) {
        this.verticalCenter()
      }
    }
...
.coupon-box {
  width: 7.76rem;
  height: 9.226667rem;
  background: url("~@/assets/img/h5_popup_ticket1@3x.png") no-repeat;
