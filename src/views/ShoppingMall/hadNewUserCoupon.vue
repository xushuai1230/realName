          ...
          <li class="coupon-li">
            ...
            <div class="coupon-right">
              <p class="money">
				...
				<div class="newuser-2-close" @click="couponClose"></div>
...
export default {
  ...
  methods: {
    couponClose () {
      this.setShowHadCouponDialog(false)
    },
    goToCoupon () {
      this.$tj('welfarenewgetclick')
      this.$router.push({
        name: 'MyCoupon'
      })
      this.setShowHadCouponDialog(false)
    ...
    ...mapMutations(['setShowHadCouponDialog'])
  },
  watch: {
