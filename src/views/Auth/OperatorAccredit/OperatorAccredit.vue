<template>
  <div class="OperatorAccredit">
    ...
    <div class="forget">
      <div class="forget__oftenUsePhone" @click="oftenUsePhoneFn">授权常用手机 &gt;&gt;</div>
      <div class="forget__password" @click="forgetFn">忘记服务密码？</div>
    </div>
    <div class="affirm">
      <div class="affirm__btn"
          :class="actionAffirmStatus ? 'btn-action-bg' : ''"
...
export default {
  ...
  methods: {
    ...
    oftenUsePhoneFn () {
      ...
      // this.$router.push({ name: 'OffenUseAccredit' })
    },
    getUserInfo () {
      this.$api['borrowHistory/getUserCreditV3']({
        ...
        if (res.code) {
          switch (res.code) {
            ...
            case 9910017:
              ...
              this.postType = 9910017
              this.shortMessageCode = 'SUBMIT_CAPTCHA'
              this.affirmDialogStatus = true
              return
            case 9910018:
              this.dialogTxt = '短信码失效请用本机发送CXXD至10001获取查询详单的验证码'
              this.postType = 9910018
              this.shortMessageCode = 'SUBMIT_CAPTCHA'
              this.affirmDialogStatus = true
              return
            default:
